...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { date: @movement.date, movement_type: @movement.movement_type, product_id: @movement.product_id, quantity: @movement.quantity } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { date: @movement.date, movement_type: @movement.movement_type, product_id: @movement.product_id, quantity: @movement.quantity } }
